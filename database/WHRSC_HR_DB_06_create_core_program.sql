...
BEGIN
    ...
    V_RLVNTDATANAME := 'originalBranch';
		V_XMLVALUE := I_FIELD_DATA.EXTRACT('/DOCUMENT/PROCESS_VARIABLE/originalBranch/text()');
		IF V_XMLVALUE IS NOT NULL THEN
			V_VALUE := V_XMLVALUE.GETSTRINGVAL();
		ELSE
			V_VALUE := NULL;
...
BEGIN
    ...
    V_RLVNTDATANAME := 'requestNumber';
		...
		UPDATE BIZFLOW.RLVNTDATA SET VALUE = V_VALUE WHERE RLVNTDATANAME = V_RLVNTDATANAME AND PROCID = I_PROCID;
        V_RLVNTDATANAME := 'reqAdminEditable';
		V_XMLVALUE := I_FIELD_DATA.EXTRACT('/DOCUMENT/PROCESS_VARIABLE/reqAdminEditable/text()');
		IF V_XMLVALUE IS NOT NULL THEN
			V_VALUE := V_XMLVALUE.GETSTRINGVAL();
		ELSE
			V_VALUE := NULL;
    ...
    V_RLVNTDATANAME := 'deVacPos1';
		V_XMLVALUE := I_FIELD_DATA.EXTRACT('/DOCUMENT/PROCESS_VARIABLE/deVacPos1/text()');
		IF V_XMLVALUE IS NOT NULL THEN
			V_VALUE := V_XMLVALUE.GETSTRINGVAL();
      SELECT REPLACE(V_VALUE, '&lt;', '<') INTO V_VALUE FROM DUAL;
      SELECT REPLACE(V_VALUE, '&gt;', '>') INTO V_VALUE FROM DUAL;
   ...
   V_RLVNTDATANAME := 'deVacPos2';
		V_XMLVALUE := I_FIELD_DATA.EXTRACT('/DOCUMENT/PROCESS_VARIABLE/deVacPos2/text()');
		IF V_XMLVALUE IS NOT NULL THEN
			V_VALUE := V_XMLVALUE.GETSTRINGVAL();
      SELECT REPLACE(V_VALUE, '&lt;', '<') INTO V_VALUE FROM DUAL;
      SELECT REPLACE(V_VALUE, '&gt;', '>') INTO V_VALUE FROM DUAL;
    ...
    V_RLVNTDATANAME := 'deVacPos3';
		V_XMLVALUE := I_FIELD_DATA.EXTRACT('/DOCUMENT/PROCESS_VARIABLE/deVacPos3/text()');
		IF V_XMLVALUE IS NOT NULL THEN
			V_VALUE := V_XMLVALUE.GETSTRINGVAL();
      SELECT REPLACE(V_VALUE, '&lt;', '<') INTO V_VALUE FROM DUAL;
      SELECT REPLACE(V_VALUE, '&gt;', '>') INTO V_VALUE FROM DUAL;
    ...
    V_RLVNTDATANAME := 'deVacPos4';
		V_XMLVALUE := I_FIELD_DATA.EXTRACT('/DOCUMENT/PROCESS_VARIABLE/deVacPos4/text()');
		IF V_XMLVALUE IS NOT NULL THEN
			V_VALUE := V_XMLVALUE.GETSTRINGVAL();
      SELECT REPLACE(V_VALUE, '&lt;', '<') INTO V_VALUE FROM DUAL;
      SELECT REPLACE(V_VALUE, '&gt;', '>') INTO V_VALUE FROM DUAL;
    ...
    V_RLVNTDATANAME := 'deVacPos5';
		V_XMLVALUE := I_FIELD_DATA.EXTRACT('/DOCUMENT/PROCESS_VARIABLE/deVacPos5/text()');
		IF V_XMLVALUE IS NOT NULL THEN
			V_VALUE := V_XMLVALUE.GETSTRINGVAL();
      SELECT REPLACE(V_VALUE, '&lt;', '<') INTO V_VALUE FROM DUAL;
      SELECT REPLACE(V_VALUE, '&gt;', '>') INTO V_VALUE FROM DUAL;
    ...
    V_RLVNTDATANAME := 'deVacPos6';
		V_XMLVALUE := I_FIELD_DATA.EXTRACT('/DOCUMENT/PROCESS_VARIABLE/deVacPos6/text()');
		IF V_XMLVALUE IS NOT NULL THEN
			V_VALUE := V_XMLVALUE.GETSTRINGVAL();
      SELECT REPLACE(V_VALUE, '&lt;', '<') INTO V_VALUE FROM DUAL;
      SELECT REPLACE(V_VALUE, '&gt;', '>') INTO V_VALUE FROM DUAL;
    ...
    V_RLVNTDATANAME := 'deVacPos7';
		V_XMLVALUE := I_FIELD_DATA.EXTRACT('/DOCUMENT/PROCESS_VARIABLE/deVacPos7/text()');
		IF V_XMLVALUE IS NOT NULL THEN
			V_VALUE := V_XMLVALUE.GETSTRINGVAL();
      SELECT REPLACE(V_VALUE, '&lt;', '<') INTO V_VALUE FROM DUAL;
      SELECT REPLACE(V_VALUE, '&gt;', '>') INTO V_VALUE FROM DUAL;
    ...
    V_RLVNTDATANAME := 'deVacPos8';
		V_XMLVALUE := I_FIELD_DATA.EXTRACT('/DOCUMENT/PROCESS_VARIABLE/deVacPos8/text()');
		IF V_XMLVALUE IS NOT NULL THEN
			V_VALUE := V_XMLVALUE.GETSTRINGVAL();
      SELECT REPLACE(V_VALUE, '&lt;', '<') INTO V_VALUE FROM DUAL;
      SELECT REPLACE(V_VALUE, '&gt;', '>') INTO V_VALUE FROM DUAL;
    ...
    V_RLVNTDATANAME := 'deVacPos9';
		V_XMLVALUE := I_FIELD_DATA.EXTRACT('/DOCUMENT/PROCESS_VARIABLE/deVacPos9/text()');
		IF V_XMLVALUE IS NOT NULL THEN
			V_VALUE := V_XMLVALUE.GETSTRINGVAL();
      SELECT REPLACE(V_VALUE, '&lt;', '<') INTO V_VALUE FROM DUAL;
      SELECT REPLACE(V_VALUE, '&gt;', '>') INTO V_VALUE FROM DUAL;
    ...
    V_RLVNTDATANAME := 'deVacPos10';
		V_XMLVALUE := I_FIELD_DATA.EXTRACT('/DOCUMENT/PROCESS_VARIABLE/deVacPos10/text()');
		IF V_XMLVALUE IS NOT NULL THEN
			V_VALUE := V_XMLVALUE.GETSTRINGVAL();
      SELECT REPLACE(V_VALUE, '&lt;', '<') INTO V_VALUE FROM DUAL;
      SELECT REPLACE(V_VALUE, '&gt;', '>') INTO V_VALUE FROM DUAL;
    ...
    V_RLVNTDATANAME := 'deCaseReturnedComment1';
		V_XMLVALUE := I_FIELD_DATA.EXTRACT('/DOCUMENT/PROCESS_VARIABLE/deCaseReturnedComment1/text()');
		IF V_XMLVALUE IS NOT NULL THEN
			V_VALUE := V_XMLVALUE.GETSTRINGVAL();
		ELSE
			V_VALUE := NULL;
    ...
    V_RLVNTDATANAME := 'deCaseReturnedComment2';
		V_XMLVALUE := I_FIELD_DATA.EXTRACT('/DOCUMENT/PROCESS_VARIABLE/deCaseReturnedComment2/text()');
		IF V_XMLVALUE IS NOT NULL THEN
			V_VALUE := V_XMLVALUE.GETSTRINGVAL();
		ELSE
			V_VALUE := NULL;
    ...
    V_RLVNTDATANAME := 'deCaseReturnedComment3';
		V_XMLVALUE := I_FIELD_DATA.EXTRACT('/DOCUMENT/PROCESS_VARIABLE/deCaseReturnedComment3/text()');
		IF V_XMLVALUE IS NOT NULL THEN
			V_VALUE := V_XMLVALUE.GETSTRINGVAL();
		ELSE
			V_VALUE := NULL;
    ...
    V_RLVNTDATANAME := 'deCaseReturnedComment4';
		V_XMLVALUE := I_FIELD_DATA.EXTRACT('/DOCUMENT/PROCESS_VARIABLE/deCaseReturnedComment4/text()');
		IF V_XMLVALUE IS NOT NULL THEN
			V_VALUE := V_XMLVALUE.GETSTRINGVAL();
		ELSE
			V_VALUE := NULL;
    ...
    V_RLVNTDATANAME := 'deCaseReturnedComment5';
		V_XMLVALUE := I_FIELD_DATA.EXTRACT('/DOCUMENT/PROCESS_VARIABLE/deCaseReturnedComment5/text()');
		IF V_XMLVALUE IS NOT NULL THEN
			V_VALUE := V_XMLVALUE.GETSTRINGVAL();
		ELSE
			V_VALUE := NULL;
    ...
    V_RLVNTDATANAME := 'deCaseReturnedComment6';
		V_XMLVALUE := I_FIELD_DATA.EXTRACT('/DOCUMENT/PROCESS_VARIABLE/deCaseReturnedComment6/text()');
		IF V_XMLVALUE IS NOT NULL THEN
			V_VALUE := V_XMLVALUE.GETSTRINGVAL();
		ELSE
			V_VALUE := NULL;
    ...
    V_RLVNTDATANAME := 'deCaseReturnedComment7';
		V_XMLVALUE := I_FIELD_DATA.EXTRACT('/DOCUMENT/PROCESS_VARIABLE/deCaseReturnedComment7/text()');
		IF V_XMLVALUE IS NOT NULL THEN
			V_VALUE := V_XMLVALUE.GETSTRINGVAL();
		ELSE
			V_VALUE := NULL;
    ...
    V_RLVNTDATANAME := 'deCaseReturnedComment8';
		V_XMLVALUE := I_FIELD_DATA.EXTRACT('/DOCUMENT/PROCESS_VARIABLE/deCaseReturnedComment8/text()');
		IF V_XMLVALUE IS NOT NULL THEN
			V_VALUE := V_XMLVALUE.GETSTRINGVAL();
		ELSE
			V_VALUE := NULL;
    ...
    V_RLVNTDATANAME := 'deCaseReturnedComment9';
		V_XMLVALUE := I_FIELD_DATA.EXTRACT('/DOCUMENT/PROCESS_VARIABLE/deCaseReturnedComment9/text()');
		IF V_XMLVALUE IS NOT NULL THEN
			V_VALUE := V_XMLVALUE.GETSTRINGVAL();
		ELSE
			V_VALUE := NULL;
    ...
    V_RLVNTDATANAME := 'deCaseReturnedComment10';
		V_XMLVALUE := I_FIELD_DATA.EXTRACT('/DOCUMENT/PROCESS_VARIABLE/deCaseReturnedComment10/text()');
		IF V_XMLVALUE IS NOT NULL THEN
			V_VALUE := V_XMLVALUE.GETSTRINGVAL();
		ELSE
			V_VALUE := NULL;
    ...
    V_RLVNTDATANAME := 'deCommBR2';
		V_XMLVALUE := I_FIELD_DATA.EXTRACT('/DOCUMENT/PROCESS_VARIABLE/deCommBR2/text()');
		IF V_XMLVALUE IS NOT NULL THEN
			V_VALUE := V_XMLVALUE.GETSTRINGVAL();
      SELECT REPLACE(V_VALUE, '&lt;', '<') INTO V_VALUE FROM DUAL;
      SELECT REPLACE(V_VALUE, '&gt;', '>') INTO V_VALUE FROM DUAL;
    ...
    V_RLVNTDATANAME := 'deCommBR3';
		V_XMLVALUE := I_FIELD_DATA.EXTRACT('/DOCUMENT/PROCESS_VARIABLE/deCommBR3/text()');
		IF V_XMLVALUE IS NOT NULL THEN
			V_VALUE := V_XMLVALUE.GETSTRINGVAL();
      SELECT REPLACE(V_VALUE, '&lt;', '<') INTO V_VALUE FROM DUAL;
      SELECT REPLACE(V_VALUE, '&gt;', '>') INTO V_VALUE FROM DUAL;
    ...
    V_RLVNTDATANAME := 'deCommBR4';
		V_XMLVALUE := I_FIELD_DATA.EXTRACT('/DOCUMENT/PROCESS_VARIABLE/deCommBR4/text()');
		IF V_XMLVALUE IS NOT NULL THEN
			V_VALUE := V_XMLVALUE.GETSTRINGVAL();
      SELECT REPLACE(V_VALUE, '&lt;', '<') INTO V_VALUE FROM DUAL;
      SELECT REPLACE(V_VALUE, '&gt;', '>') INTO V_VALUE FROM DUAL;
    ...
    V_RLVNTDATANAME := 'deCommBR5';
		V_XMLVALUE := I_FIELD_DATA.EXTRACT('/DOCUMENT/PROCESS_VARIABLE/deCommBR5/text()');
		IF V_XMLVALUE IS NOT NULL THEN
			V_VALUE := V_XMLVALUE.GETSTRINGVAL();
      SELECT REPLACE(V_VALUE, '&lt;', '<') INTO V_VALUE FROM DUAL;
      SELECT REPLACE(V_VALUE, '&gt;', '>') INTO V_VALUE FROM DUAL;
    ...
    V_RLVNTDATANAME := 'deCommBR6';
		V_XMLVALUE := I_FIELD_DATA.EXTRACT('/DOCUMENT/PROCESS_VARIABLE/deCommBR6/text()');
		IF V_XMLVALUE IS NOT NULL THEN
			V_VALUE := V_XMLVALUE.GETSTRINGVAL();
      SELECT REPLACE(V_VALUE, '&lt;', '<') INTO V_VALUE FROM DUAL;
      SELECT REPLACE(V_VALUE, '&gt;', '>') INTO V_VALUE FROM DUAL;
    ...
    V_RLVNTDATANAME := 'deCommBR7';
		V_XMLVALUE := I_FIELD_DATA.EXTRACT('/DOCUMENT/PROCESS_VARIABLE/deCommBR7/text()');
		IF V_XMLVALUE IS NOT NULL THEN
			V_VALUE := V_XMLVALUE.GETSTRINGVAL();
      SELECT REPLACE(V_VALUE, '&lt;', '<') INTO V_VALUE FROM DUAL;
      SELECT REPLACE(V_VALUE, '&gt;', '>') INTO V_VALUE FROM DUAL;
    ...
    V_RLVNTDATANAME := 'deCommBR8';
		V_XMLVALUE := I_FIELD_DATA.EXTRACT('/DOCUMENT/PROCESS_VARIABLE/deCommBR8/text()');
		IF V_XMLVALUE IS NOT NULL THEN
			V_VALUE := V_XMLVALUE.GETSTRINGVAL();
      SELECT REPLACE(V_VALUE, '&lt;', '<') INTO V_VALUE FROM DUAL;
      SELECT REPLACE(V_VALUE, '&gt;', '>') INTO V_VALUE FROM DUAL;
    ...
    V_RLVNTDATANAME := 'deCommBR9';
		V_XMLVALUE := I_FIELD_DATA.EXTRACT('/DOCUMENT/PROCESS_VARIABLE/deCommBR9/text()');
		IF V_XMLVALUE IS NOT NULL THEN
			V_VALUE := V_XMLVALUE.GETSTRINGVAL();
      SELECT REPLACE(V_VALUE, '&lt;', '<') INTO V_VALUE FROM DUAL;
      SELECT REPLACE(V_VALUE, '&gt;', '>') INTO V_VALUE FROM DUAL;
    ...
    V_RLVNTDATANAME := 'deCommBR10';
		V_XMLVALUE := I_FIELD_DATA.EXTRACT('/DOCUMENT/PROCESS_VARIABLE/deCommBR10/text()');
		IF V_XMLVALUE IS NOT NULL THEN
			V_VALUE := V_XMLVALUE.GETSTRINGVAL();
      SELECT REPLACE(V_VALUE, '&lt;', '<') INTO V_VALUE FROM DUAL;
      SELECT REPLACE(V_VALUE, '&gt;', '>') INTO V_VALUE FROM DUAL;
						...
						, XMLTABLE('/DOCUMENT/DETERMINE'
							...
							COLUMNS
								...
								,ACTION_TYPE				    VARCHAR2(50) PATH 'ACTION_TYPE'
							       ...
							       ,RYB_STATUS             VARCHAR2(50) PATH 'if(ACTION_TYPE/text() = "Cancel") then null else RYB_STATUS'
...
create or replace PROCEDURE SP_UPDATE_RECRUITMENT_PROCESS
 ...
 , I_FIELD_DATA      IN      XMLTYPE
      ...
      BEGIN
            ...
            , X.SUBMITTED_PCKG_QLTY_COMMENTS
         	 FROM TBL_FORM_DTL FD  
  				  		...
  				  		,DATE_RECEIVED						DATE PATH 'TRANSACTION/DATE_RECEIVED'
	    					 ,DATE_SF52_RECEIVED				DATE PATH 'TRANSACTION/DATE_SF52_RECEIVED'
								...
								, INSTITUTE							VARCHAR2(30) PATH 'TRANSACTION/INSTITUTE'
								 ,ORG_INITS							VARCHAR2(72) PATH 'TRANSACTION/ORG_INITS'
                ...
                ,JOB_OPENING_ID					VARCHAR2(30) PATH 'PRERECRUITMENT/JOB_OPENING_ID'
      ...
      BEGIN
            ...
            ,X.GRADE
        	 FROM TBL_FORM_DTL FD  
						, XMLTABLE('/DOCUMENT'
							...
							COLUMNS
								TRANSACTION_ID					NUMBER(10)  PATH 'MAIN/TRANSACTION_ID'
                ,POSITION_TITLE				VARCHAR2(100) PATH 'PRERECRUITMENT/POSITION_TITLE'
               ,PAY_PLAN              VARCHAR2(100) PATH 'PRERECRUITMENT/PAYPLAN'
               ,SERIES                VARCHAR2(30) PATH 'PRERECRUITMENT/SERIES'
               ,GRADE                   VARCHAR2(30) PATH 'PRERECRUITMENT/GRADE'
						) X
					WHERE X.TRANSACTION_ID = I_TRANSACTIONID
				) SRC ON (SRC.TRANSACTION_ID = TRG.TRANSACTION_ID)
				WHEN MATCHED THEN UPDATE SET
	   ...
	   BEGIN
         	 ...
         	 FROM TBL_FORM_DTL FD  
                ...
                --,NUM_POSITIONS_TO_BE_ADV					NUMBER(10)  PATH 'PRERECRUITMENT/NUM_POSITIONS_TO_BE_ADV'
							...
							,INCENTIVES_OFFERED							VARCHAR2(1000) PATH 'PRERECRUITMENT/INCENTIVES_OFFERED'
                                ...
                                ,ANN_QUAL_REVIEWER							VARCHAR2(100)  PATH 'PRERECRUITMENT/ANN_QUAL_REVIEWER'
          ...
          ,TRG.LEGISLATIVE_INIT_SUPPORTED = SRC.LEGISLATIVE_INIT_SUPPORTED
                  ...
                  ,TRG.ANN_QUAL_REVIEWER = SRC.ANN_QUAL_REVIEWER
        ...
        ,SRC.ANN_QUAL_REVIEWER
        ,SRC.DATE_REC_PCKG_SENT_DEU
        ,SRC.DATE_REC_PCKG_SENT_APPROVED
        ,SRC.REC_PCKG_NOTES
      )
      ;      
	...
	--------------------------------
        V_XMLVALUE :=I_FIELD_DATA.EXTRACT('/DOCUMENT/MAIN/ANN_OPENED/text()');
        IF V_XMLVALUE IS NOT NULL THEN
          V_VALUE := V_XMLVALUE.GETSTRINGVAL();
                ...
                ,ACTION_TYPE				    VARCHAR2(50) PATH 'TRANSACTION/ACTION_TYPE'
  				  		,DATE_RECEIVED						DATE PATH 'TRANSACTION/DATE_RECEIVED'
	    					 ,DATE_SF52_RECEIVED				DATE PATH 'TRANSACTION/DATE_SF52_RECEIVED'
							    ...
							    ,RYB_DESCRIPTION        VARCHAR2(50) PATH 'TRANSACTION/RYB_DESCRIPTION'
								,COMMENTS_STATUS					varchar2(4000)   PATH 'TRANSACTION/COMMENTS_STATUS'		
                ,JOB_OPENING_ID					VARCHAR2(30) PATH 'APPOINTMENT/A_CAP_HR_JOB_REQ'
