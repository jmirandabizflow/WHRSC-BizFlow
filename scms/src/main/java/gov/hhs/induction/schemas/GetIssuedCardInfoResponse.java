 ...
 *         &lt;element name="CHUID" type="{http://hspd12.hhs.gov/federated/enrollment/v1}CHUIDDataFieldsType" maxOccurs="unbounded" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
@XmlRootElement(name = "GetIssuedCardInfoResponse")
public class GetIssuedCardInfoResponse {
    ...
    protected List<CHUIDDataFieldsType> chuid;
     ...
     * This is why there is not a <CODE>set</CODE> method for the chuid property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getCHUID().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<CHUIDDataFieldsType> getCHUID() {
        if (chuid == null) {
            chuid = new ArrayList<CHUIDDataFieldsType>();
        }
        return this.chuid;
    }
