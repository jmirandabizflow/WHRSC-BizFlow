 ...
 *           &lt;/simpleType&gt;
 *         &lt;/element&gt;
 *         &lt;element name="HashData" type="{http://hspd12.hhs.gov/federated/enrollment/v1}SyncApplicantInfoHashType" maxOccurs="1000" minOccurs="0"/&gt;
...
@XmlRootElement(name = "SyncGetApplicantInfoHashResponse")
public class SyncGetApplicantInfoHashResponse {

    @XmlElement(name = "ResultCode", required = true)
    protected String resultCode;
    @XmlElement(name = "HashData")
    protected List<SyncApplicantInfoHashType> hashData;
     ...
     * This is why there is not a <CODE>set</CODE> method for the hashData property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getHashData().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link SyncApplicantInfoHashType }
     * 
     * 
     */
    public List<SyncApplicantInfoHashType> getHashData() {
        if (hashData == null) {
            hashData = new ArrayList<SyncApplicantInfoHashType>();
        }
