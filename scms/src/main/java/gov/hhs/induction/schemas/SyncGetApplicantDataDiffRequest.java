 ...
 *         &lt;element name="ApplicantData" type="{http://hspd12.hhs.gov/federated/enrollment/v1}InductionDataType" maxOccurs="100"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
@XmlRootElement(name = "SyncGetApplicantDataDiffRequest")
public class SyncGetApplicantDataDiffRequest {
    ...
    protected List<InductionDataType> applicantData;
     ...
     * This is why there is not a <CODE>set</CODE> method for the applicantData property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getApplicantData().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<InductionDataType> getApplicantData() {
        if (applicantData == null) {
            applicantData = new ArrayList<InductionDataType>();
        }
